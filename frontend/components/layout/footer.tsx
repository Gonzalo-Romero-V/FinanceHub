    ...
    <footer className="w-full border-t bg-background py-6">
      <div className="container mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-8 px-4 text-center md:text-left">
        <div className="flex flex-col gap-1">
          <h3 className="small font-bold text-brand-1/80">Desarrollado por</h3>
        ...
        <div className="flex flex-col gap-1">
          <h3 className="small font-bold text-brand-1/80">Contacto</h3>
        ...
        <div className="flex flex-col gap-1">
          <h3 className="small font-bold text-brand-1/80">Donaciones</h3>
          <Link 
